...
const recipeData = [
  {
    ...
    image: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fpublic-assets-ucg.meredithcorp.io%2Fb62e3edf420b0cf9a9d04738fcb8dd7c%2F4520479.jpg&q=60&c=sc&orient=true&poi=auto&h=512',
    user_id: 1,
    comment_id: 1,
    tag_id:1,
  },
  {
    ...
    difficulty: 'Medium',
    ingredients: '1 tablespoon olive oil, 4 skinless, boneless chicken thighs, cut into small pieces, 1 onion, cut in half and sliced, 2 cups dashi stock, made with dashi powder, ¼ cup soy sauce, 3 tablespoons mirin (Japanese rice wine), 3 tablespoons brown sugar, 4 large eggs, 4 cups hot cooked white rice',    
    ...
    image: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fpublic-assets-ucg.meredithcorp.io%2F8c872874bdbe675afb33a3cfb49ab5b2%2F3963616.jpg&q=60&c=sc&orient=true&poi=auto&h=512',
    user_id: 1,
    comment_id: 2,
    tag_id:2,
  },
  {
    ...
    difficulty: 'Easy',
    ingredients: '4 large eggs, separated, 2 ½ teaspoons instant dark roast coffee, ½ cup white sugar, 1 tablespoon marsala wine, ¼ pinch salt, 1 ¼ cups heavy cream',    
    ...
    image: 'https://www.allrecipes.com/thmb/2AawdSSOqYaL57DKiEU56yNDd4Q=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Tiramoussa-Semifreddo-1x1-1-2000-fdc0bef2c5954a3ba86079ce5b3453b2.jpg',
    user_id: 2,
    comment_id: 4,
    tag_id: 4,
  },
  {
    ...
    preparation_time: 35,
    difficulty: 'Hard',
    ingredients: '1 (8 ounce) round Brie cheese, 1 (8 ounce) package phyllo dough, thawed, 1 cup raspberry jam, 1 cup butter, melted, 2 tablespoons honey, flakey salt to taste',    
    ...
    image: 'https://www.allrecipes.com/thmb/GrVhwxPBTtdK14R7-eVyHii9Cfo=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Air-Fried-Raspberry-Brie-Bites-1x1-1-febbe855420f421e9d355c388aea6cc3.jpg',
    user_id: 2,
    comment_id: 3,
    tag_id: 4,
  },
